...
# Expects environment to provide: BUILD_PREFIX, CONDA_BUILD_ZIG

case "${_ZIG_MODE}" in
  cc)  _zig_target_bin="${BUILD_PREFIX}/bin/${CONDA_BUILD_ZIG}-cc"  ;;
  c++) _zig_target_bin="${BUILD_PREFIX}/bin/${CONDA_BUILD_ZIG}-cxx" ;;
  *)
