...
[[ -x "${_wrapper_dir}/@ZIG_TARGET@-zig-cc" ]]         && export ZIG_CC="${_wrapper_dir}/@ZIG_TARGET@-zig-cc"
[[ -x "${_wrapper_dir}/@ZIG_TARGET@-zig-cxx" ]]        && export ZIG_CXX="${_wrapper_dir}/@ZIG_TARGET@-zig-cxx"
[[ -x "${_wrapper_dir}/@ZIG_TARGET@-zig-ar" ]]         && export ZIG_AR="${_wrapper_dir}/@ZIG_TARGET@-zig-ar"
[[ -x "${_wrapper_dir}/@ZIG_TARGET@-zig-ranlib" ]]     && export ZIG_RANLIB="${_wrapper_dir}/@ZIG_TARGET@-zig-ranlib"
[[ -x "${_wrapper_dir}/@ZIG_TARGET@-zig-asm" ]]        && export ZIG_ASM="${_wrapper_dir}/@ZIG_TARGET@-zig-asm"
[[ -x "${_wrapper_dir}/@ZIG_TARGET@-zig-rc" ]]         && export ZIG_RC="${_wrapper_dir}/@ZIG_TARGET@-zig-rc"
[[ -x "${_wrapper_dir}/@ZIG_TARGET@-zig-lld" ]]        && export ZIG_LLD="${_wrapper_dir}/@ZIG_TARGET@-zig-lld"
[[ -x "${_wrapper_dir}/@ZIG_TARGET@-zig-force-load-cc" ]]  && export ZIG_FORCE_LOAD_CC="${_wrapper_dir}/@ZIG_TARGET@-zig-force-load-cc"
[[ -x "${_wrapper_dir}/@ZIG_TARGET@-zig-force-load-cxx" ]] && export ZIG_FORCE_LOAD_CXX="${_wrapper_dir}/@ZIG_TARGET@-zig-force-load-cxx"
